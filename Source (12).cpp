...
void Product::displayProduct()
{
	...
	cout << "product Price is :" << setiosflags(ios::fixed) << setprecision(2) << price << endl;
...
void cart::Displaycart()
{
	...
	if (cartDetailNo > 0) {
		...
		cout << " Cart Total :" << setiosflags(ios::fixed) << setprecision(2) << Total << endl;
	}
	else
	{
...
void Order::viewOrderDetails()
{
	if (orderid != 0)
	{
		...
		cout << "Total amount:" << setiosflags(ios::fixed) << setprecision(2) << this->crt->getTotal() << endl;
